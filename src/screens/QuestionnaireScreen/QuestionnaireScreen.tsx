...
//       if (user) {
//         // Save under UID if user is logged in
//         await firestore()
//           .collection('user_preferences')
//           .doc(user.uid)
//           .set(userPreferences, { merge: true });
//       } else {
//         // Save as anonymous doc
//         await firestore().collection('user_preferences').add(userPreferences);
//       }

//       // Keep onboarding flag in AsyncStorage
//       await AsyncStorage.setItem(ONBOARDING_COMPLETE_KEY, 'true');

//       navigation.replace('Home');
//     } catch (error) {
//       console.log('Error saving preferences to Firestore:', error);
//     }
//   };
...
//             <TouchableOpacity
//               style={[styles.option, personType === 'Night Owl' && styles.optionSelected]}
//               onPress={() => handlePersonTypeChange('Night Owl')}
//             >
//               <Text style={styles.optionIcon}>🌙</Text>
//               <Text style={styles.optionText}>Night Owl</Text>
...
//   scrollContent: { flexGrow: 1, paddingHorizontal: spacing.xl, paddingTop: spacing.md, paddingBottom: spacing.xxl },
//   progressContainer: { marginBottom: spacing.xl, backgroundColor: '#f0f0f0', height: 4, borderRadius: 2, width: '100%' },
//   progressBar: { height: 4, borderRadius: 2, marginBottom: spacing.sm },
//   progressText: { textAlign: 'center', color: colors.text.secondary, ...typography.bodySmall, marginTop: spacing.xs },
//   questionContainer: { marginBottom: spacing.xl },
//   questionTitle: { ...typography.h2, marginBottom: spacing.lg },
//   moodContainer: { flexDirection: 'row', justifyContent: 'space-between', marginTop: spacing.md },
...
//   volumeKnob: { position: 'absolute', width: 20, height: 20, backgroundColor: '#fff', borderRadius: 10, borderWidth: 2, borderColor: colors.primary, transform: [{ translateX: -10 }] },
//   optionRow: { flexDirection: 'row', justifyContent: 'space-between', marginTop: spacing.md },
//   option: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: spacing.md, borderRadius: radius.md, borderWidth: 1, borderColor: colors.input.border, marginHorizontal: spacing.xs },
...
//   environmentOption: { flex: 1, height: 100, marginHorizontal: spacing.xs, borderRadius: radius.md, overflow: 'hidden', borderWidth: 2, borderColor: colors.input.border },
...
//   avatarOption: { width: Dimensions.get('window').width * 0.35, height: Dimensions.get('window').width * 0.35, borderRadius: radius.md, borderWidth: 2, borderColor: 'transparent', overflow: 'hidden', marginHorizontal: spacing.sm, alignItems: 'center', justifyContent: 'center' },
...
//   nameInput: { borderWidth: 0, borderBottomWidth: 1, borderColor: colors.input.border, paddingVertical: spacing.md, color: colors.text.primary, ...typography.body },
...
//   backButton: { paddingVertical: spacing.md, paddingHorizontal: spacing.xl, borderRadius: 50, borderWidth: 1, borderColor: colors.primary, justifyContent: 'center', alignItems: 'center', width: '40%' },
